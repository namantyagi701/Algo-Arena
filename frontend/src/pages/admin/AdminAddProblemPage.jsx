...
/** Convert a structured arg into its JS value for JSON serialisation */
...
/** Serialize an array of structured args into the JSON string the backend expects */
    ...
    <div className="max-w-4xl">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-base-content/60 mt-1">Create a new coding problem</p>
        </div>
      </div>
              ...
              {form.descriptionNotes.map((note, i) => (
                <div key={i} className="flex gap-2 mb-2">
                  <input
                    ...
                    value={note}
                    onChange={(e) => updateArrayItem("descriptionNotes", i, e.target.value)}
              ...
              <div key={i} className="border border-base-300 rounded-lg p-4 mb-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <div className="form-control">
                    ...
                    <input
                      ...
                      value={example.input}
                      onChange={(e) => updateArrayItem("examples", i, { ...example, input: e.target.value })}
                  ...
                  <div className="form-control">
                    ...
                    <input
                      ...
                      onChange={(e) => updateArrayItem("examples", i, { ...example, output: e.target.value })}
                      placeholder="e.g. [0, 1]"
                    />
                  </div>
                </div>
                <div className="form-control mt-2">
                  ...
                  <input
                    ...
                    onChange={(e) => updateArrayItem("examples", i, { ...example, explanation: e.target.value })}
                  />
                </div>
              </div>
            ))}
            ...
            {["javascript", "python", "java"].map((lang) => (
              <div key={lang} className="form-control mt-2">
                <label className="label">
                  <span className="label-text font-medium capitalize">{lang}</span>
                </label>
                <textarea

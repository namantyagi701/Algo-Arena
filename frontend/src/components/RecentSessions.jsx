...
function RecentSessions({ sessions, isLoading }) {
  return (
    <div className="card bg-base-100/90 backdrop-blur-sm border-2 border-accent/20 hover:border-accent/30 mt-8 transition-all duration-300">
      <div className="card-body">
        <div className="flex items-center gap-3 mb-6">
          <div className="p-2 bg-gradient-to-br from-accent to-secondary rounded-xl shadow-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 stagger-children">
          {isLoading ? (
            ...
            sessions.map((session) => (
              <div
                key={session._id}
                className={`card relative hover-glow transition-all duration-300 ${
                  session.status === "active"
                    ? "bg-success/10 border-success/30 hover:border-success/60"
                    : "bg-base-200/80 border-base-300 hover:border-primary/30"
                }`}
              >
                {session.status === "active" && (
                ...
                <div className="card-body p-5">
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-base-300/50">
                    <span className="text-xs font-semibold opacity-80 uppercase tracking-wider">Completed</span>
            ...
            <div className="col-span-full text-center py-16">
              <div className="w-20 h-20 mx-auto mb-4 bg-gradient-to-br from-accent/20 to-secondary/20 rounded-3xl flex items-center justify-center animate-float">
